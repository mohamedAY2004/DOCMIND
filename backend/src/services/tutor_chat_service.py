...
class TutorChatService:
    ...
    async def _prepare_turn(self, owner: User, conv_id: str, text: str,
        ...
        subject_manifest, material_index = await build_subject_corpus(self._session, subject_id)
        ...
        return PreparedChatTurn(conv, text, collection_for_subject(subject_id),
                                MessageRole.ASSISTANT, "material", history,
                                subject_name, subject_manifest, material_index)
